  ...
  tenant_admin: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Pacotes', route: '/tenant/pacotes', icon: '📦', disabled: true },
        { label: 'Criar pacote', route: '/tenant/pacotes', icon: '🧩', disabled: true },
        { label: 'Serviços inclusos', route: '/tenant/pacotes', icon: '📋', disabled: true },
    ...
    },
    {
      ...
      items: [
        { label: 'Caixa', route: '/tenant/financeiro', icon: '💵', disabled: true },
        { label: 'Entradas / saídas', route: '/tenant/financeiro', icon: '↕️', disabled: true },
        { label: 'Recebimentos', route: '/tenant/financeiro', icon: '💸', disabled: true },
        ...
        { label: 'Cobranças recorrentes', route: '/tenant/financeiro', icon: '🔄', disabled: true },
        { label: 'Inadimplência', route: '/tenant/financeiro', icon: '🚫', disabled: true },
        { label: 'Transações', route: '/tenant/financeiro', icon: '📑', disabled: true },
        { label: 'Histórico', route: '/tenant/financeiro', icon: '🕘', disabled: true },
        { label: 'Webhooks', route: '/tenant/financeiro', icon: '🔌', disabled: true }
      ]
    },
    {
      type: 'section',
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Horário funcionamento', route: '/tenant/configuracoes-gerais', icon: '🕒' },
